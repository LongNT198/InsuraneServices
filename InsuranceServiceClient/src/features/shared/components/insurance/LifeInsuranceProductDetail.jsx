...
export function LifeInsuranceProductDetail() {
  const { id } = useParams();
  ...
  const handleApplyCustomPlan = () => {
    ...
    navigate(`/apply-life?productId=${product.insuranceProductId}&coverage=${customCoverage}&term=${parseInt(customTerm)}&frequency=${urlFrequency}&premium=${customPremium}&custom=true`);
  };
  ...
  const handleApplyNow = async (planId = null) => {
    ...
    navigate(`/apply-life?productId=${id}&planId=${targetPlanId}&frequency=${selectedPaymentFrequency}`);
  };
    ...
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center">
          ...
          <Button asChild>
            <Link to="/life-insurance">Back to Life Insurance</Link>
          </Button>
        </div>
      </div>
    );
  ...
  const keyBenefits = [
    {
      ...
      description: 'Protect your family with coverage up to $500,000'
    },
    {
      icon: Heart,
      title: 'Lifetime Protection',
      description: 'Guaranteed coverage that lasts a lifetime'
    },
    {
      icon: TrendingUp,
      title: 'Cash Value Growth',
      description: 'Build wealth with guaranteed 4% annual growth'
    },
    {
      icon: Users,
      title: 'Family Benefits',
      description: 'Additional benefits for your loved ones'
    }
  ];
  ...
  const coverageScope = [
    {
      ...
      items: [
        { name: 'Natural Death', covered: true, details: 'Full sum assured paid to beneficiaries' },
        { name: 'Accidental Death', covered: true, details: 'Additional 100% of sum assured' },
        { name: 'Death by Illness', covered: true, details: 'Covered after waiting period (90 days)' },
        { name: 'Suicide (After 1 Year)', covered: true, details: 'Covered if policy is active for 1+ year' },
        { name: 'Suicide (Within 1 Year)', covered: false, details: 'Premiums refunded, no death benefit' },
      ]
    },
    {
      category: 'Critical Illness Coverage',
      items: [
        { name: 'Cancer (All Stages)', covered: true, details: 'Lump sum payment upon diagnosis' },
        { name: 'Heart Attack', covered: true, details: 'Immediate payout for major heart attack' },
        { name: 'Stroke', covered: true, details: 'Coverage for permanent neurological damage' },
        { name: 'Kidney Failure', covered: true, details: 'Requiring dialysis or transplant' },
        { name: 'Major Organ Transplant', covered: true, details: 'Heart, lung, liver, kidney, pancreas' },
        { name: 'Paralysis', covered: true, details: 'Total and permanent paralysis' },
        { name: 'Alzheimer\'s Disease', covered: true, details: 'Before age 60 only' },
      ]
    },
    {
      category: 'Disability Benefits',
      items: [
        { name: 'Total Permanent Disability', covered: true, details: 'Premium waiver + lump sum payment' },
        { name: 'Partial Disability', covered: true, details: 'Proportional benefit based on disability %' },
        { name: 'Temporary Disability', covered: false, details: 'Not covered in standard plans' },
        { name: 'Occupational Disability', covered: true, details: 'Unable to perform current occupation' },
      ]
    },
    {
      category: 'Additional Benefits',
      items: [
        { name: 'Terminal Illness', covered: true, details: 'Accelerated death benefit (life expectancy <12 months)' },
        { name: 'Hospitalization Cash', covered: true, details: 'Daily allowance during hospitalization' },
        { name: 'Funeral Expenses', covered: true, details: 'Up to $10,000 immediate payout' },
        { name: 'Child Education Benefit', covered: true, details: 'Premium waiver if policyholder dies' },
      ]
    }
  ];
  ...
  const exclusions = [
    {
      category: 'Death Not Covered',
      items: [
        'Suicide within first 12 months of policy',
        'Death during criminal activity or illegal acts',
        'Death due to war, terrorism, or civil commotion',
        'Death during aviation (as pilot or crew member)',
        'Death during extreme sports (skydiving, base jumping)',
        'Pre-existing terminal illness not disclosed',
      ]
    },
    {
      category: 'Critical Illness Exclusions',
      items: [
        'Pre-existing conditions not disclosed during application',
        'Self-inflicted injuries or attempted suicide',
        'Alcohol or drug abuse related conditions',
        'HIV/AIDS related illnesses (unless through blood transfusion)',
        'Genetic disorders known before policy start',
        'Non-life threatening cancers (stage 0, skin cancers)',
      ]
    },
    {
      category: 'Disability Exclusions',
      items: [
        'Disability from pre-existing conditions',
        'Temporary or partial disabilities (in basic plans)',
        'Mental illness or psychological disorders',
        'Back pain without objective medical evidence',
        'Disability during intoxication',
      ]
    },
    {
      ...
      items: [
        ...
        'Claims outside policy territory (international exclusions)',
        'Non-disclosure or misrepresentation of information',
        'Lapsed policy (grace period expired)',
      ]
    }
  ];
  ...
  const claimsProcess = [
    {
      ...
      description: 'Notify us within 30 days of the event',
      details: 'Call our 24/7 helpline or submit online claim form',
    ...
    },
    {
      ...
      details: 'Death certificate, medical reports, claim form, ID proof, beneficiary details',
      timeline: '7-14 days',
      icon: FileText
    },
    {
      ...
      details: 'Verification of documents, policy validity check, investigation if needed',
      timeline: '15-30 days',
      icon: ClipboardCheck
    },
    {
      ...
      description: 'Decision and notification',
      details: 'Approval/rejection letter sent via email and post',
      timeline: '2-5 days',
      icon: FileCheck
    },
    {
      ...
      details: 'Direct bank transfer to beneficiary account',
      timeline: '3-7 days',
      icon: Banknote
    }
  ];
  ...
  const whoShouldBuy = [
    {
      ...
      description: 'Parents with young children who depend on your income',
      reason: 'Protect your family\'s future and ensure their financial security'
    },
    {
      icon: Briefcase,
      title: 'Primary Breadwinners',
      description: 'Main income earner in the household',
      reason: 'Replace income and maintain family\'s standard of living'
    },
    {
      icon: Home,
      title: 'Homeowners with Mortgage',
      description: 'Have outstanding home loans or mortgages',
      reason: 'Ensure mortgage is paid off even if something happens to you'
    },
    {
      icon: GraduationCap,
      title: 'Parents Planning Education',
      description: 'Want to secure children\'s education expenses',
      reason: 'Build cash value for future education costs'
    },
    {
      icon: TrendingUp,
      title: 'Long-term Investors',
      description: 'Looking for tax-advantaged savings vehicle',
      reason: 'Cash value grows tax-deferred, can be borrowed against'
    },
    {
      icon: UserCheck,
      title: 'Business Owners',
      description: 'Entrepreneurs with business partners or key employees',
      reason: 'Fund buy-sell agreements, protect business continuity'
    }
  ];
      ...
      <div className="bg-white border-b">
        <div className="container mx-auto px-4 py-3">
          <nav className="flex items-center gap-2 text-sm">
            ...
            <Link to="/life-insurance" className="text-gray-500 hover:text-blue-600 transition-colors">
              Life Insurance
            </Link>
            <ArrowRight className="size-3.5 text-gray-400" />
              ...
              <CardContent>
                <div className="grid md:grid-cols-3 gap-6">
                  {relatedProducts.map((relProduct, idx) => (
                    <Link
                      key={relProduct.id}
                      to={`/life-insurance/${relProduct.id}`}
