...
import { 
  ...
  ChevronDown, ChevronUp, Wrench, Settings, Fuel, MapPin, Zap, Percent
} from 'lucide-react';
...
export function MotorInsuranceProductDetail() {
  ...
  const loadProductDetails = async () => {
    try {
      ...
      // Load related products (other Motor Insurance products)
      try {
        const relatedResponse = await productsService.getProductsByType('Motor');
    ...
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center">
          <div className="animate-spin size-12 border-4 border-orange-600 border-t-transparent rounded-full mx-auto mb-4"></div>
  ...
  const keyBenefits = [
    ...
    },
    {
      ...
      description: 'Hassle-free repairs at network garages'
    }
  ];
  ...
  const coverageScope = [
    {
      ...
      items: [
        { name: 'Accident Damage', covered: true, details: 'Covers repair/replacement due to road accidents' },
        { name: 'Fire & Explosion', covered: true, details: 'Full protection against fire and explosion damage' },
        { name: 'Theft & Burglary', covered: true, details: 'Complete vehicle theft and break-in coverage' },
        { name: 'Natural Disasters', covered: true, details: 'Storm, flood, earthquake, landslide damage' },
        { name: 'Man-made Disasters', covered: true, details: 'Riot, strike, malicious acts coverage' },
      ]
    },
    {
      category: 'Third-Party Liability',
      items: [
        { name: 'Death/Injury Liability', covered: true, details: 'Unlimited coverage for third-party death/injury' },
        { name: 'Property Damage Liability', covered: true, details: 'Up to policy limit for third-party property' },
        { name: 'Legal Liability', covered: true, details: 'Legal costs and compensation covered' },
      ]
    },
    {
      category: 'Personal Accident Cover',
      items: [
        { name: 'Owner-Driver PA', covered: true, details: '$15,000 cover for owner-driver death/disability' },
        { name: 'Unnamed Passengers', covered: true, details: 'Optional cover for all passengers (add-on)' },
        { name: 'Paid Driver', covered: true, details: 'PA cover for hired/paid driver (add-on)' },
      ]
    },
    {
      category: 'Additional Benefits',
      items: [
        { name: 'Zero Depreciation', covered: true, details: 'Full claim without depreciation on parts (add-on)' },
        { name: 'Engine Protection', covered: true, details: 'Covers engine and gearbox damage (add-on)' },
        { name: 'Roadside Assistance', covered: true, details: '24/7 emergency towing, fuel delivery, flat tire' },
        { name: 'Consumables Cover', covered: true, details: 'Covers oil, nuts, bolts, screws (add-on)' },
        { name: 'Key Replacement', covered: true, details: 'Lost/stolen key replacement (add-on)' },
        { name: 'NCB Protection', covered: true, details: 'Protects No Claim Bonus even after claim (add-on)' },
      ]
    }
  ];
  ...
  const exclusions = [
    {
      ...
      items: [
        'Driving without valid license or expired license',
        'Driving under influence of alcohol or drugs',
        'Using vehicle for wrong purpose (private vs commercial)',
        'Unauthorized driver not listed in policy',
        'Violating traffic rules or regulations',
    ...
    },
    {
      ...
      items: [
        ...
        'Damage to tires (unless vehicle damaged too)',
        'Depreciation in vehicle value',
        'Consequential loss (loss of use, income)',
        'Damage while using for commercial purposes (unless covered)',
      ]
    },
    {
      category: 'Specific Perils',
      items: [
        'War, invasion, terrorism, nuclear risks',
        'Drunk driving or driving under substance influence',
        'Contractual liability beyond legal liability',
        'Damage outside geographical coverage area',
    ...
    },
    {
      ...
      items: [
        'Consequential losses (rental costs, lost wages)',
        'Passengers not covered under PA add-on',
        'Using vehicle for hire/reward without coverage',
        'Accessories not declared in policy',
        'Claims without proper documentation/proof',
      ]
    }
  ];
  ...
  const claimsProcess = [
    {
      ...
      description: 'Inform us immediately after accident',
      details: 'Call 24/7 hotline, file FIR if needed, take photos of accident scene',
    ...
    },
    {
      ...
      description: 'Provide claim documentation',
      details: 'FIR copy, driving license, RC, photos, repair estimates, third-party details',
      timeline: '3-5 days',
      icon: FileText
    },
    {
      ...
      details: 'Our surveyor inspects vehicle damage, verifies claim, prepares report',
      timeline: '3-7 days',
      icon: ClipboardCheck
    },
    {
      ...
      details: 'Claim approved with settlement amount based on policy and damage',
      timeline: '2-5 days',
      icon: FileCheck
    },
    {
      ...
      description: 'Settlement or cashless repair',
      details: 'Direct payment to you or cashless repair at network garage',
      timeline: '5-10 days',
      icon: Banknote
    }
  ];
  ...
  const whoShouldBuy = [
    {
      ...
      description: 'Recently purchased a brand new vehicle',
      reason: 'Zero depreciation and comprehensive protection for new cars'
    },
    {
      icon: Users,
      title: 'Daily Commuters',
      description: 'Use vehicle daily for work or school',
      reason: 'Reliable coverage for everyday road risks and accidents'
    },
    {
      icon: MapPin,
      title: 'Frequent Long-Distance Travelers',
      description: 'Often drive long distances or highways',
      reason: '24/7 roadside assistance and breakdown coverage'
    },
    {
      icon: Shield,
      title: 'Luxury/High-Value Car Owners',
      description: 'Own expensive or premium vehicles',
      reason: 'Full value protection with zero depreciation add-on'
    },
    {
      icon: Briefcase,
      title: 'Commercial Vehicle Owners',
      description: 'Use vehicle for business or commercial purposes',
      reason: 'Specialized coverage for commercial use and liability'
    },
    {
      icon: Fuel,
      title: 'High Mileage Drivers',
      description: 'Drive extensively with high annual mileage',
      reason: 'Engine protection and comprehensive wear coverage'
    }
  ];
      ...
      <div className="bg-white border-b">
        <div className="container mx-auto px-4 py-3">
          <nav className="flex items-center gap-2 text-sm">
            ...
            <Link to="/motor-insurance" className="text-gray-500 hover:text-orange-600 transition-colors">
              Motor Insurance
            </Link>
            <ArrowRight className="size-3.5 text-gray-400" />
            ...
            <div className="flex items-start justify-between gap-6">
              <div className="flex-1">
                <Badge className="mb-4 bg-white/20 text-white border-white/30 hover:bg-white/30 transition-colors">
                  {product?.productCode || 'MOTOR-001'}
                </Badge>
                <h1 className="text-3xl md:text-5xl font-bold mb-4 leading-tight">
                  {product?.productName || 'Motor Insurance Product'}
                </h1>
                <p className="text-lg md:text-xl text-orange-100 mb-6 leading-relaxed">
                  {product?.description || 'Comprehensive Motor Insurance coverage for your property and belongings'}
                </p>
                <div className="flex flex-wrap gap-4">
                  <div className="flex items-center gap-2 bg-white/10 backdrop-blur-sm px-4 py-2.5 rounded-lg hover:bg-white/20 transition-colors">
                    ...
                    <span className="text-orange-100 text-sm">(1,245 reviews)</span>
                  </div>
                  <div className="flex items-center gap-2 bg-white/10 backdrop-blur-sm px-4 py-2.5 rounded-lg hover:bg-white/20 transition-colors">
                    <Users className="size-5" />
                    <span className="font-semibold">50,000+</span>
                    <span className="text-orange-100 text-sm">policyholders</span>
                  </div>
                  <div className="flex items-center gap-2 bg-white/10 backdrop-blur-sm px-4 py-2.5 rounded-lg hover:bg-white/20 transition-colors">
                    <Shield className="size-5" />
                    <span className="font-semibold">98.5%</span>
                    <span className="text-orange-100 text-sm">claim settlement</span>
                  </div>
                </div>
              </div>
              <div className="hidden md:block">
                <div className="bg-white/10 backdrop-blur-sm border-2 border-white/20 rounded-2xl p-6 text-center hover:bg-white/15 transition-all duration-300">
                  <Car className="size-16 mx-auto mb-3 text-orange-200" />
                  <p className="text-sm text-orange-100 mb-1">Coverage up to</p>
        ...
        <div className="max-w-6xl mx-auto">
          <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-8">
            ...
            <TabsContent value="overview" className="space-y-8 animate-in fade-in-50 duration-500">
              ...
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    Complete protection designed for your home and peace of mind
                  </CardDescription>
                </CardHeader>
                <CardContent>
                      ...
                      <div key={index} className="flex gap-4">
                        <div className="flex-shrink-0">
                          <div className="size-12 rounded-lg bg-orange-100 flex items-center justify-center">
                            <benefit.icon className="size-6 text-orange-600" />
                          </div>
                        </div>
                        <div>
                  ...
                  {features.length > 0 ? (
                    ...
                    <div className="grid md:grid-cols-2 gap-4">
                      <div className="flex items-start gap-3">
                        <CheckCircle2 className="size-5 text-green-600 mt-0.5 flex-shrink-0" />
                        <span className="text-gray-700">Full replacement cost coverage for structure and contents</span>
                      </div>
                      <div className="flex items-start gap-3">
                        <CheckCircle2 className="size-5 text-green-600 mt-0.5 flex-shrink-0" />
                        <span className="text-gray-700">24/7 emergency home repair assistance</span>
                      </div>
                      <div className="flex items-start gap-3">
                        <CheckCircle2 className="size-5 text-green-600 mt-0.5 flex-shrink-0" />
                      ...
                      <div className="flex items-start gap-3">
                        <CheckCircle2 className="size-5 text-green-600 mt-0.5 flex-shrink-0" />
                        <span className="text-gray-700">Liability coverage up to $300,000</span>
                      </div>
                      <div className="flex items-start gap-3">
                        <CheckCircle2 className="size-5 text-green-600 mt-0.5 flex-shrink-0" />
                        <span className="text-gray-700">Temporary housing coverage if home is uninhabitable</span>
                      </div>
                      <div className="flex items-start gap-3">
                        <CheckCircle2 className="size-5 text-green-600 mt-0.5 flex-shrink-0" />
                        <span className="text-gray-700">Protection against fire, theft, vandalism, and natural disasters</span>
                      </div>
                      <div className="flex items-start gap-3">
                        <CheckCircle2 className="size-5 text-green-600 mt-0.5 flex-shrink-0" />
                        <span className="text-gray-700">No deductible for total loss claims</span>
                      </div>
                      <div className="flex items-start gap-3">
                        <CheckCircle2 className="size-5 text-green-600 mt-0.5 flex-shrink-0" />
                        <span className="text-gray-700">Optional riders for earthquake, flood, and valuable items</span>
                      </div>
                    </div>
                  )}
                </CardContent>
                ...
                <CardContent>
                  <div className="grid md:grid-cols-2 gap-6">
                    <div className="space-y-3">
                      ...
                      <div className="flex justify-between items-center py-2 border-b">
                        <span className="text-gray-600">Vehicle Inspection Fee</span>
                        <span className="font-semibold text-gray-900">
                          ${product.medicalCheckupFee ? Number(product.medicalCheckupFee).toFixed(2) : '150.00'}
                        </span>
                      </div>
                      <div className="flex justify-between items-center py-2 border-b">
            ...
            <TabsContent value="plans" id="plans-section" className="space-y-8 animate-in fade-in-50 duration-500">
              ...
              <div className="text-center mb-12">
                ...
                <h2 className="mb-4">Motor Insurance Plans</h2>
                <p className="text-gray-600 max-w-2xl mx-auto">
                  Choose your payment frequency and compare plans. Prices based on property value and location.
                </p>
              </div>
                ...
                <CardHeader>
                  <div className="flex items-center justify-between">
                    ...
                    <Button
                      ...
                      className="!text-orange-600 hover:!text-orange-700 hover:!bg-orange-100 !cursor-pointer"
                    >
                      {showCustomPlan ? (
                    ...
                    <div className="grid md:grid-cols-2 gap-6">
                      ...
                      <div className="space-y-6">
                        ...
                        <div className="space-y-3">
                          <div className="flex items-center justify-between">
                            ...
                            <Badge variant="secondary" className="text-base font-bold text-orange-700">
                                ...
                                <div className="flex flex-wrap gap-2">
                                  ...
                                  {uniqueTerms.map((term, idx) => (
                                    <button
                                      ...
                                      className="px-2 py-1 text-xs !bg-orange-100 !text-orange-700 rounded hover:!bg-orange-200 !cursor-pointer transition-colors"
                                    >
                                      {term}Y
                                    </button>
                                  ))}
                        ...
                        <Button
                          ...
                          className="w-full !bg-orange-600 hover:!bg-orange-700 !cursor-pointer disabled:!opacity-50 disabled:!cursor-not-allowed"
                        >
                          {calculatingCustom ? (
                            <>
                      ...
                      <div className="space-y-4">
                        {customPremium ? (
                          ...
                          <div className="border-2 border-dashed border-orange-200 rounded-xl p-8 text-center space-y-3">
                            <div className="bg-orange-100 rounded-full size-16 flex items-center justify-center mx-auto">
                ...
                <>
                  <div className="grid md:grid-cols-3 gap-6">
                    ...
                    <Card className="bg-gradient-to-br from-orange-50 to-orange-100 border-orange-200">
                      <CardContent className="p-6 text-center">
                        <TrendingUp className="size-12 text-orange-600 mx-auto mb-3" />
                  ...
                  <div className="space-y-4">
                    {[
                      ...
                      },
                      {
                        ...
                        a: 'Standard Motor Insurance does not cover flood damage. You\'ll need a separate flood insurance policy. However, water damage from burst pipes or roof leaks is typically covered.'
                      },
                      {
          ...
          <Card className="mt-12">
            <CardHeader>
              <CardTitle className="text-2xl flex items-center gap-2">
                <UserCheck className="size-7 text-orange-600" />
                Who Should Buy This Policy?
              </CardTitle>
              <CardDescription>
                This Motor Insurance is ideal for these property owners
              </CardDescription>
            </CardHeader>
            <CardContent>
                  ...
                  <div key={idx} className="flex gap-4 p-4 border rounded-lg hover:shadow-md transition">
                    <div className="flex-shrink-0">
                      <div className="size-12 rounded-full bg-orange-100 flex items-center justify-center">
                        <persona.icon className="size-6 text-orange-600" />
                      </div>
                    </div>
                    <div>
                      ...
                      <p className="text-xs text-orange-600 font-medium">→ {persona.reason}</p>
                    </div>
                  </div>
                ))}
              </div>
          ...
          {relatedProducts.length > 0 && (
            <Card className="mt-8">
              <CardHeader>
                <CardTitle className="text-2xl flex items-center gap-2">
                  <Building2 className="size-7 text-orange-600" />
                  Related Motor Insurance Products
                </CardTitle>
                <CardDescription>
                  Compare similar Motor Insurance products to find the best fit
                </CardDescription>
              </CardHeader>
              <CardContent>
                <div className="grid md:grid-cols-3 gap-6">
                  {relatedProducts.map((relProduct, idx) => (
                    ...
                    >
                      <Card className="h-full hover:shadow-xl hover:border-purple-300 transition-all duration-300 transform hover:scale-105">
                        <CardHeader>
                          <div className="flex items-start justify-between mb-2">
                            <Car className="size-8 text-orange-600 group-hover:scale-110 transition-transform duration-300" />
                        ...
                        <CardContent>
                          <div className="space-y-3">
                            <div className="flex items-center justify-between text-sm">
                              ...
                              <span className="font-bold text-orange-600 group-hover:translate-x-1 transition-transform duration-300 inline-flex items-center gap-1">
          ...
          <div className="grid md:grid-cols-4 gap-4 mt-8">
            <Card className="bg-orange-50 border-orange-200 hover:shadow-lg transition-all duration-300 transform hover:scale-105 cursor-pointer group">
              <CardContent className="p-6 text-center">
                <Star className="size-10 text-orange-600 mx-auto mb-2 group-hover:scale-110 transition-transform duration-300" />
            ...
            <Card className="bg-orange-50 border-orange-200 hover:shadow-lg transition-all duration-300 transform hover:scale-105 cursor-pointer group">
              <CardContent className="p-6 text-center">
                <CheckCircle2 className="size-10 text-orange-600 mx-auto mb-2 group-hover:scale-110 transition-transform duration-300" />
          ...
          {/* CTA Section */}
          <Card className="mt-12 bg-gradient-to-r from-orange-600 to-red-600 text-white border-0">
          ...
          <div className="grid md:grid-cols-3 gap-6 mt-8">
            <Card>
              <CardContent className="p-6 text-center">
                <Phone className="size-8 text-orange-600 mx-auto mb-3" />
                <h4 className="font-semibold mb-1">Call Us</h4>
                <p className="text-sm text-gray-600 mb-2">Mon-Fri 8AM-8PM</p>
                <p className="font-semibold text-orange-600">1-800-MOTOR</p>
              </CardContent>
            </Card>
            
            <Card>
              <CardContent className="p-6 text-center">
                <MessageCircle className="size-8 text-orange-600 mx-auto mb-3" />
                <h4 className="font-semibold mb-1">Live Chat</h4>
                <p className="text-sm text-gray-600 mb-2">Available 24/7</p>
                <Button variant="link" className="text-orange-600 p-0 cursor-pointer">Start Chat</Button>
              </CardContent>
            </Card>
            
            <Card>
              <CardContent className="p-6 text-center">
                <Mail className="size-8 text-orange-600 mx-auto mb-3" />
                <h4 className="font-semibold mb-1">Email</h4>
                <p className="text-sm text-gray-600 mb-2">Response within 24h</p>
                <p className="font-semibold text-orange-600">motor@insurance.com</p>
              </CardContent>
            </Card>
          </div>
        </div>
