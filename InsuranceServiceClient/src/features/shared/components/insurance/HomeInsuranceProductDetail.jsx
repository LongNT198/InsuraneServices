...
import {
  ...
  ChevronDown, ChevronUp, Lock, Flame, Droplets, Wrench, Umbrella, Zap, Percent,
  Phone, Mail, MessageCircle, Download, Clock, Award, Target
} from 'lucide-react';
...
export function HomeInsuranceProductDetail() {
    ...
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center">
          ...
          <Button asChild>
            <Link to="/home-insurance">Back to Home Insurance</Link>
          </Button>
        </div>
      </div>
    );
  ...
  const keyBenefits = [
    {
      ...
      description: 'Full coverage for your home and belongings'
    },
    {
      icon: Flame,
      title: 'Fire & Natural Disasters',
      description: 'Protected against fire, flood, earthquake'
    },
    {
      icon: Lock,
      title: 'Theft & Burglary',
      description: 'Comprehensive security and theft coverage'
    },
    {
      icon: Umbrella,
      title: 'Liability Protection',
      description: 'Coverage for injuries on your property'
    }
  ];
  ...
  const coverageScope = [
    {
      ...
      items: [
        { name: 'Main Structure', covered: true, details: 'Walls, roof, floors, foundation up to policy limit' },
        { name: 'Attached Structures', covered: true, details: 'Garage, deck, porch permanently attached' },
        { name: 'Built-in Appliances', covered: true, details: 'HVAC, water heater, electrical systems' },
        { name: 'Plumbing & Electrical', covered: true, details: 'Pipes, wiring, fixtures throughout home' },
        { name: 'Architectural Features', covered: true, details: 'Cabinets, countertops, built-in shelving' },
      ]
    },
    {
      category: 'Contents & Belongings',
      items: [
        { name: 'Furniture & Electronics', covered: true, details: 'Up to 50% of building coverage' },
        { name: 'Clothing & Personal Items', covered: true, details: 'Full replacement value coverage' },
        { name: 'Jewelry & Valuables', covered: true, details: 'Limited to $5,000 (rider available for more)' },
        { name: 'Art & Collectibles', covered: true, details: 'Requires appraisal for high-value items' },
        { name: 'Tools & Equipment', covered: true, details: 'Home office and workshop tools included' },
        { name: 'Outdoor Furniture', covered: true, details: 'Patio furniture, grills, outdoor equipment' },
      ]
    },
    {
      category: 'Natural Disasters & Perils',
      items: [
        { name: 'Fire & Smoke Damage', covered: true, details: 'Full coverage for fire-related losses' },
        { name: 'Lightning Strike', covered: true, details: 'Damage from lightning and power surges' },
        { name: 'Windstorm & Hail', covered: true, details: 'Storm damage to structure and contents' },
        { name: 'Water Damage', covered: true, details: 'Burst pipes, roof leaks (not flood)' },
        { name: 'Theft & Vandalism', covered: true, details: 'Stolen or damaged property coverage' },
        { name: 'Falling Objects', covered: true, details: 'Trees, debris, or other falling objects' },
      ]
    },
    {
      category: 'Liability & Additional Living',
      items: [
        { name: 'Personal Liability', covered: true, details: 'Up to $300,000 for injury claims on property' },
        { name: 'Medical Payments', covered: true, details: '$5,000 per person for guest injuries' },
        { name: 'Temporary Housing', covered: true, details: 'Hotel/rental costs if home is uninhabitable' },
        { name: 'Additional Living Expenses', covered: true, details: 'Extra costs for food, transportation during repairs' },
      ]
    }
  ];
  ...
  const exclusions = [
    {
      category: 'Normal Wear and Tear',
      items: [
        'Gradual deterioration of property over time',
        'Aging of appliances and systems',
        'Routine maintenance issues (clogged drains, worn carpet)',
        'Mold from humidity or poor ventilation',
        'Pest or insect infestations',
        'Structural defects or faulty construction',
      ]
    },
    {
      category: 'Natural Disasters (Standard Policy)',
      items: [
        'Flood damage (requires separate flood insurance)',
        'Earthquake damage (requires earthquake rider)',
        'Landslide or mudslide',
        'Sinkhole collapse (unless sudden)',
        'Ground movement or settling',
        'Nuclear hazard or radiation',
      ]
    },
    {
      category: 'Specific Property Exclusions',
      items: [
        'Vacant property (unoccupied 60+ days)',
    ...
    },
    {
      ...
      items: [
        ...
        'Animals or pets (separate pet insurance)',
        'War, terrorism, or government action',
        'Power outage from external source',
  ...
  const claimsProcess = [
    {
      step: 1,
      title: 'Report Damage',
      description: 'Notify us immediately after incident',
      details: 'Call 24/7 claims hotline or file online. Take photos/videos of damage',
    ...
    },
    {
      ...
      description: 'Provide damage evidence and inventory',
      details: 'Photos, police report (if theft), repair estimates, receipts for damaged items',
      timeline: '3-7 days',
      icon: FileText
    },
    {
      ...
      description: 'Adjuster inspects damage',
      details: 'Our inspector visits property, assesses damage extent, prepares report',
      timeline: '5-10 days',
      icon: ClipboardCheck
    },
    {
      ...
      description: 'Review and settlement offer',
      details: 'Claim approved with settlement amount based on policy coverage',
      timeline: '2-5 days',
      icon: FileCheck
    },
    {
      ...
      description: 'Payment or direct repair',
      details: 'Direct payment to you or approved contractors for repairs',
      timeline: '3-7 days',
      icon: Banknote
    }
  ];
  ...
  const whoShouldBuy = [
    {
      ...
      description: 'Recently purchased your first or new home',
      reason: 'Protect your biggest investment from day one'
    },
    {
      icon: Users,
      title: 'Families with Children',
      description: 'Parents wanting to secure their family\'s living space',
      reason: 'Comprehensive coverage for family belongings and liability'
    },
    {
      icon: Building2,
      title: 'Property Investors',
      description: 'Own multiple properties or rental units',
      reason: 'Protect rental income and investment properties'
    },
    {
      icon: Briefcase,
      title: 'Home Office Workers',
      description: 'Work from home with valuable equipment',
      reason: 'Additional coverage for business equipment and liability'
    },
    {
      icon: Shield,
      title: 'High-Value Homeowners',
      description: 'Properties with valuable contents or features',
      reason: 'Customized coverage for luxury items and collectibles'
    },
    {
      icon: Umbrella,
      title: 'Risk-Conscious Owners',
      description: 'Live in areas prone to natural disasters',
      reason: 'Protection against fire, flood, earthquake, and storms'
    }
  ];
      ...
      <div className="bg-white border-b">
        <div className="container mx-auto px-4 py-3">
          <nav className="flex items-center gap-2 text-sm">
            ...
            <Link to="/home-insurance" className="text-gray-500 hover:text-purple-600 transition-colors">
              Home Insurance
            </Link>
            <ArrowRight className="size-3.5 text-gray-400" />
            ...
            <div className="flex items-start justify-between gap-6">
              <div className="flex-1">
                <Badge className="mb-4 bg-white/20 text-white border-white/30 hover:bg-white/30 transition-colors">
                  {product?.productCode || 'HOME-001'}
                </Badge>
                <h1 className="text-3xl md:text-5xl font-bold mb-4 leading-tight">
                  {product?.productName || 'Home Insurance Product'}
                </h1>
                <p className="text-lg md:text-xl text-purple-100 mb-6 leading-relaxed">
                  {product?.description || 'Comprehensive home insurance coverage for your property and belongings'}
                </p>
                <div className="flex flex-wrap gap-4">
                  <div className="flex items-center gap-2 bg-white/10 backdrop-blur-sm px-4 py-2.5 rounded-lg hover:bg-white/20 transition-colors">
                    ...
                    <span className="text-purple-100 text-sm">(1,245 reviews)</span>
                  </div>
                  <div className="flex items-center gap-2 bg-white/10 backdrop-blur-sm px-4 py-2.5 rounded-lg hover:bg-white/20 transition-colors">
                    <Users className="size-5" />
                    <span className="font-semibold">50,000+</span>
                    <span className="text-purple-100 text-sm">policyholders</span>
                  </div>
                  <div className="flex items-center gap-2 bg-white/10 backdrop-blur-sm px-4 py-2.5 rounded-lg hover:bg-white/20 transition-colors">
                    <Shield className="size-5" />
                    <span className="font-semibold">98.5%</span>
                    <span className="text-purple-100 text-sm">claim settlement</span>
                  </div>
                </div>
              </div>
              <div className="hidden md:block">
                <div className="bg-white/10 backdrop-blur-sm border-2 border-white/20 rounded-2xl p-6 text-center hover:bg-white/15 transition-all duration-300">
                  <Home className="size-16 mx-auto mb-3 text-purple-200" />
                  <p className="text-sm text-purple-100 mb-1">Coverage up to</p>
        ...
        <div className="max-w-6xl mx-auto">
          <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-8">
                ...
                <CardContent>
                  <div className="grid md:grid-cols-2 gap-6">
                    <div className="space-y-3">
                      ...
                      <div className="flex justify-between items-center py-2 border-b">
                        <span className="text-gray-600">Property Inspection Fee</span>
                        <span className="font-semibold text-gray-900">
            ...
            <TabsContent value="plans" id="plans-section" className="space-y-8 animate-in fade-in-50 duration-500">
              ...
              <div className="text-center mb-12">
                ...
                <h2 className="mb-4">Home Insurance Plans</h2>
                  ...
                  <div className="space-y-4">
                    {[
                      ...
                      },
                      {
                        ...
                        a: 'Standard home insurance does not cover flood damage. You\'ll need a separate flood insurance policy. However, water damage from burst pipes or roof leaks is typically covered.'
                      },
                      {
          ...
          <Card className="mt-12">
            <CardHeader>
              <CardTitle className="text-2xl flex items-center gap-2">
                <UserCheck className="size-7 text-purple-600" />
                Who Should Buy This Policy?
              </CardTitle>
              <CardDescription>
                This home insurance is ideal for these property owners
              </CardDescription>
            </CardHeader>
            <CardContent>
                  ...
                  <div key={idx} className="flex gap-4 p-4 border rounded-lg hover:shadow-md transition">
                    <div className="flex-shrink-0">
                      <div className="size-12 rounded-full bg-purple-100 flex items-center justify-center">
                        <persona.icon className="size-6 text-purple-600" />
                      </div>
                    </div>
                    <div>
                      ...
                      <p className="text-xs text-purple-600 font-medium">→ {persona.reason}</p>
                    </div>
                  </div>
                ))}
              </div>
            ...
            <Card className="mt-8">
              <CardHeader>
                <CardTitle className="text-2xl flex items-center gap-2">
                  ...
                  Related Home Insurance Products
                </CardTitle>
                <CardDescription>
                  Compare similar home insurance products to find the best fit
                </CardDescription>
              </CardHeader>
              <CardContent>
                <div className="grid md:grid-cols-3 gap-6">
                  {relatedProducts.map((relProduct, idx) => (
                    <Link
                      key={relProduct.id}
                      to={`/home-insurance/${relProduct.id}`}
                      ...
                      <Card className="h-full hover:shadow-xl hover:border-purple-300 transition-all duration-300 transform hover:scale-105">
                        <CardHeader>
                          <div className="flex items-start justify-between mb-2">
                            <Home className="size-8 text-purple-600 group-hover:scale-110 transition-transform duration-300" />
                        ...
                        <CardContent>
                          <div className="space-y-3">
                            <div className="flex items-center justify-between text-sm">
                              ...
                              <span className="font-bold text-purple-600 group-hover:translate-x-1 transition-transform duration-300 inline-flex items-center gap-1">
          ...
          <div className="grid md:grid-cols-4 gap-4 mt-8">
            <Card className="bg-purple-50 border-purple-200 hover:shadow-lg transition-all duration-300 transform hover:scale-105 cursor-pointer group">
              <CardContent className="p-6 text-center">
                <Star className="size-10 text-purple-600 mx-auto mb-2 group-hover:scale-110 transition-transform duration-300" />
          ...
          {/* CTA Section */}
          <Card className="mt-12 bg-gradient-to-r from-purple-600 to-indigo-600 text-white border-0">
          ...
          <div className="grid md:grid-cols-3 gap-6 mt-8">
            <Card>
              <CardContent className="p-6 text-center">
                <Phone className="size-8 text-purple-600 mx-auto mb-3" />
            ...
            <Card>
              <CardContent className="p-6 text-center">
                ...
                <p className="font-semibold text-purple-600">home@insurance.com</p>
              </CardContent>
            </Card>
          </div>
        </div>
