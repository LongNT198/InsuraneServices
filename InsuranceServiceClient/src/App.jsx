                ...
                <AppLayout>
                  <Routes>
                    ...
                    <Route
                      ...
                      element={<LifeInsuranceProductDetail />}
                    />
                    <Route
                    ...
                    />
                    <Route
                      path="/medical-insurance/:id"
                      element={<MedicalInsuranceProductDetail />}
                    />
                    <Route
                    ...
                    />
                    <Route
                      path="/motor-insurance/:id"
                      element={<MotorInsuranceProductDetail />}
                    />
                    <Route path="/home-insurance" element={<HomeInsurance />} />
                    <Route
                      path="/home-insurance/:id"
                      element={<HomeInsuranceProductDetail />}
                    />
